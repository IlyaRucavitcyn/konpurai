        ...
        <Stack direction="row" spacing={1}>
          <Button
            ...
            sx={{
              textTransform: "none",
              backgroundColor:
                viewMode === "category" ? "#1769AB" : "transparent",
              borderColor: "#1769AB",
              color: viewMode === "category" ? "white" : "#1769AB",
              "&:hover": {
                backgroundColor:
                  viewMode === "category" ? "#1769AB" : "#13715B10",
              },
            }}
          >
            Risk Categories
          ...
          <Button
            ...
            sx={{
              textTransform: "none",
              backgroundColor:
                viewMode === "lifecycle" ? "#1769AB" : "transparent",
              borderColor: "#1769AB",
              color: viewMode === "lifecycle" ? "white" : "#1769AB",
              "&:hover": {
                backgroundColor:
                  viewMode === "lifecycle" ? "#1769AB" : "#13715B10",
              },
            }}
          >
            AI Lifecycle
