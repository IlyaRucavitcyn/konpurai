...
const Button = memo(
  React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ children, sx, testId, className, ...rest }, ref) => {
      ...
      const defaultStyles: SxProps<Theme> = {
        ...
        border: `1px solid ${theme.palette.primary.main || "#1769AB"}`,
        backgroundColor: theme.palette.primary.main || "#1769AB",
        ...
        "&:focus": {
          outline: `2px solid ${theme.palette.primary.main || "#1769AB"}`,
          outlineOffset: "2px",
        },
