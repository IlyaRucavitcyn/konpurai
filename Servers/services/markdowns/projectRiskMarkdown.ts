...
export async function getProjectRiskMarkdown(
  ...
  const projectRiskMD = `
${data.organizationName || 'Konpurai'} project risk report
========================

This report is generated by the Konpurai Project Risk. It aims to provide a way to demonstrate their claims about the risks of their AI systems.
