  ...
  try {
    ...
    if (framework) {
      ...
      if (framework.name === "EU AI Act") {
        ...
        const euAIMD = `
${data.organizationName || 'Konpurai'} ${framework.name} report
========================

This report is generated by Konpurai. It aims to provide a way to demonstrate their claims about the risks of their AI systems.
...
`;
    ...
    throw new Error(
      `Failed to generate all reports: ${error instanceof Error ? error.message : "Unknown error"
      }`
    );
  }
}
