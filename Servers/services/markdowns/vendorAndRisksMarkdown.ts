...
export async function getVendorReportMarkdown(
  ...
  return `
${data.organizationName || 'Konpurai'} vendors and vendor risks report
-------------
This report is generated by Konpurai. It aims to give information about the company's vendors and corresponding vendor risks.
      ...
      vendorData && vendorData.length > 0
        ? await Promise.all(
          vendorData.map(async (vendor) => {
            ...
            return `| ${vendor.vendor_name} | ${vendorAssignee.name} ${vendorAssignee.surname
