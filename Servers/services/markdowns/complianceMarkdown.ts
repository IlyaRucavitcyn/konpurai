...
export async function getComplianceMarkdown(
  ...
  const complianceMD = `
${data.organizationName || "Konpurai"} compliance tracker report
========================

This report is generated by the Konpurai Compliance Tracker. It aims to provide a way to demonstrate their claims about the risks of their AI systems.
                  ...
                  const subControls =
                    control.subControls?.length > 0
                      ? control.subControls
                        .map(
                          (subcontrol, j) =>
                            `    ${j + 1}. __${subcontrol.title
                            }__<br> Implementation detail: ${subcontrol.implementation_details
                            }`
                        )
                        .join("\n")
